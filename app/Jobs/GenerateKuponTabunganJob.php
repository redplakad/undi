...
class GenerateKuponTabunganJob implements ShouldQueue
{
    ...
    public function handle()
    {
        for ($i = 1; $i <= $this->jumlah_kupon; $i++) { 
            ...
            KuponTabungan::create([
                ...
                'produk' => $this->peserta->jenis_tabungan,
                'status' => 0
            ]);
        }
    }
