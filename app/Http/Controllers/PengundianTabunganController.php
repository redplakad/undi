...
class PengundianTabunganController extends Controller
{
    //
    public function simpan(Request $request)
    {
        ...
        $validated = $request->validate([
            'form_id_peserta' => 'required|exists:peserta_tabungan,id', // Sesuaikan dengan kolom di tabel peserta_tabungan
        ...
        // Simpan data pemenang_tabungan
        try {
            $savePemenang = PemenangTabungan::create([
