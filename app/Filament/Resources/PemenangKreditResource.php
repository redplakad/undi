...
use App\Filament\Resources\PemenangKreditResource\Pages;
use App\Filament\Resources\PemenangKreditResource\RelationManagers;
...
class PemenangKreditResource extends Resource
{
    protected static ?string $model = PemenangKredit::class;
    ...
    {
        return 'Pemenang Kredit'; // Ganti dengan title navigasi yang diinginkan
    }

    public function getTitle(): string
    {
        return __('Pemenang Kredit');
    }
    ...
    {
        return [
            'index' => Pages\ListPemenangKredits::route('/'),
            //'create' => Pages\CreatePemenangKredit::route('/create'),
            //'edit' => Pages\EditPemenangKredit::route('/{record}/edit'),
        ];
    }
}
