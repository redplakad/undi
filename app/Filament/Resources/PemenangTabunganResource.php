...
use App\Filament\Resources\PemenangTabunganResource\Pages;
use App\Filament\Resources\PemenangTabunganResource\RelationManagers;
...
class PemenangTabunganResource extends Resource
{
    protected static ?string $model = PemenangTabungan::class;
    ...
    {
        return 'Pemenang Tabungan'; // Ganti dengan title navigasi yang diinginkan
    }

    public function getTitle(): string
    {
        return __('Pemenang Tabungan');
    }
    ...
    {
        return [
            'index' => Pages\ListPemenangTabungans::route('/'),
            //'create' => Pages\CreatePemenangTabungan::route('/create'),
            'edit' => Pages\EditPemenangTabungan::route('/{record}/edit'),
        ];
    }
}
