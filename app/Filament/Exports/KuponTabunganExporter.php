...
class KuponTabunganExporter extends Exporter
{
    ...
    {
        $body = 'Your kupon tabungan export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
