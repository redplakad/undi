<x-filament-panels::page>
    ...
    @endif
    <form action="{{ route('generate.kupon.kredit') }}" method="post" class="bg-white space-y-4 p-4 border rounded-lg shadow-sm max-w-lg">
        @csrf
        <div class="flex flex-col">
            ...
            <input type="text" id="saldo-kupon" name="saldo_kupon" required class="p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="10,000,000" value="10000000">
        </div>
        <div class="flex flex-col">
            <label for="saldo-kupon" class="mb-2 text-lg font-medium text-gray-700">Status Kredit<sup class="text-danger-600 dark:text-danger-400 font-medium">*</sup></label>
            <select name="status" required class="p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="100,000" value="100000">
                <option disabled>Pilih status kredit</option>
