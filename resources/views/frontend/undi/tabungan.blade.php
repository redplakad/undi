...
<body class="text-gray-800">
    <main class="container mx-auto px-4 py-8 center">
        ...
        <section class="text-center mt-8 mb-5">
            <h1 class="text-[3rem] font-extrabold" style="color: #4574b8">
                UNDIAN TABUNGAN BERHADIAH TAHUN {{ date('Y')}}
            </h1>
            ...
            <div class="w-[70%] bg-white p-6 rounded shadow">
                ...
                <div class="box flex flex-col items-center justify-center gap-4 p-6">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="{{ route('undi.tabungan') }}" class="btn btn-warning text-white">
            ...
            <div class="card-body">
                ...
                <div class="modal-action">
                    <form method="dialog">
                        ...
                        <a href="{{ route('undi.tabungan') }}" class="btn btn-error" id="resetButton">Reset</a>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        function createPemenangTabungan() {
            ...
            $.ajax({
            url: '{{ env("APP_URL") }}/api/pemenang-tabungan', // Ganti dengan endpoint API Anda
            method: 'POST',
            data: data,
        ...
        $(document).ready(function() {
            ...
            async function fetchNomorRekening(produk) {
                try {
                    ...
                    `{{ env('APP_URL') }}/api/nomor-kupon-tabungan/${produk}`); // Ganti URL sesuai dengan server Anda
            ...
            function getWinner(winner) {
                ...
                axios.get(`${window.location.origin}/api/kupon-tabungan/${winner}`)
